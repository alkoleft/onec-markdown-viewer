...
export default function (hljs: HLJSApi): Language {
    ...
    const UNDERSCORE_IDENT_RE: string = '[A-Za-zА-Яа-яёЁ_][A-Za-zА-Яа-яёЁ_0-9]+';

    // v8 ключевые слова ==> keyword
    const KEYWORD: string =
        'функция возврат вызватьисключение выполнить для если и из или иначе иначеесли исключение каждого конецесли '
        + 'конецпопытки конеццикла не новый перейти перем по пока попытка прервать продолжить тогда цикл экспорт '
        + 'процедура функция конецпроцедуры конецфункции знач ';
    ...
    const v8_global_context_methods: string =
    ...
    const v8_global_context_property: string =
    ...
    const BUILTIN: string = v8_global_context_methods + v8_global_context_property;
